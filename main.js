const defaultAttributesScores = [15, 14, 13, 12, 10, 8];
...
class Player{
    constructor(charcterName = 'Naruto'){
        ...
        let shuffledResult = shuffleArray(defaultAttributesScores);
...
// Fisher-Yates algorithm for randomly sorting array
// from: https://dev.to/codebubb/how-shuffle-an-array-in-javascript-2ikj
